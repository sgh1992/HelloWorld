...
package core.src.main.java.org.apache.mahout.cf.taste.impl.common;
...
public final class RefreshHelper implements Refreshable {
  ...
  /**
   * Typically this is called in {@link Refreshable#refresh(Collection)} and is the entire body of
   * that method.
   */
  @Override
