...
package core.src.main.java.org.apache.mahout.cf.taste.impl.recommender.svd;
...
public final class SVDRecommender extends AbstractRecommender {
   ...
   *
   * The {@link #refresh(Collection) refresh} method recomputes the factorization and overwrites the store.
   *
   * @param dataModel
   * @param factorizer
