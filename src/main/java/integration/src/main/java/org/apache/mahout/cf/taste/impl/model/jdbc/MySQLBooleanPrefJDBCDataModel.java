...
package integration.src.main.java.org.apache.mahout.cf.taste.impl.model.jdbc;
...
public class MySQLBooleanPrefJDBCDataModel extends AbstractBooleanPrefJDBCDataModel {
  ...
  /**
   * <p>
   * Creates a {@link MySQLBooleanPrefJDBCDataModel} using the default {@link DataSource} (named
  ...
  /**
   * <p>
   * Creates a {@link MySQLBooleanPrefJDBCDataModel} using the default {@link DataSource} found
  ...
  /**
   * <p>
   * Creates a {@link MySQLBooleanPrefJDBCDataModel} using the given {@link DataSource} and default
   * table/column names.
   * </p>
   * 
   * @param dataSource
